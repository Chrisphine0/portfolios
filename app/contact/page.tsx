...
const socialLinks = [
  { name: 'GitHub', icon: Github, url: 'https://github.com/Chrisphine0', color: 'hover:text-gray-900' },
  {
    name: 'LinkedIn',
    icon: Linkedin,
    url: 'https://linkedin.com/in/miyawachrisphine',
...
function ContactForm() {
  ...
  // Set subject from query parameter
  useEffect(() => {
    if (subjectFromQuery) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        setFormData({ name: '', email: '', subject: subjectFromQuery || '', message: '' })
        setIsSuccess(false)
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          miyawachrisphineodhiambo@gmail.com
                        </p>
                      </div>
                    </div>
